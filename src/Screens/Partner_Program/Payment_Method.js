          ...
          <View
            ...
            <View
              ...
              <Text
                ...
                Your car is ready for booking. Your listing has been
                successfully added to the platform. Get ready to start earning.
              </Text>
              <TouchableOpacity
                onPress={() => {
                  setModalVisible(false);
                  navigation.navigate('BottomNavigation'); // or any screen name you want
                }}
                style={{
                  backgroundColor: '#000',
                  paddingVertical: 12,
